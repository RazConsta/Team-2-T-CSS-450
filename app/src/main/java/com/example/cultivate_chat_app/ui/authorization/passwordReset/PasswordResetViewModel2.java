...
public class PasswordResetViewModel2 extends AndroidViewModel {

    private MutableLiveData<JSONObject> mResponse;

    public PasswordResetViewModel2(@NonNull Application application) {
        super(application);
    ...
    public void reset(final String email, final String password) {
        String url = "https://cultivate-app-web-service.herokuapp.com/resetPassword";
